...
{
    public class NormalDistributionPDF : Distribution
    {
        ...
        public NormalDistributionPDF(double[] dataset, double mean, double sigma)
        {
            _mean = mean;
            _sigma = sigma;
        ...
        public NormalDistributionPDF(double value, double mean, double sigma)
        {
            _mean = mean;
            _sigma = sigma;
